...
#import "NSDate+ChineseCalendar.h"

@implementation NSDate (ChineseCalendar)
...
+ (NSString *)chineseCalendarWithDate:(NSDate *)date{
    return [self chineseCalendarWithDate:date options:ChineseCalendarOptionDay|ChineseCalendarOptionMonth|ChineseCalendarOptionShuXiang|ChineseCalendarOptionTianGanDiZhi];
}
...
+(NSString *)chineseCalendarWithDate:(NSDate *)date options:(ChineseCalendarOptions)options{
    ...
    if(options&ChineseCalendarOptionTianGanDiZhi){
        [szNongli appendString:tempTianGan];
        [szNongli appendString:tempDiZhi];
    }
    if(options&ChineseCalendarOptionShuXiang){
        [szNongli appendString:szShuXiang];
    };
    if(options&ChineseCalendarOptionTianGanDiZhi || options&ChineseCalendarOptionShuXiang){
        [szNongli appendString:@"年"];
    }
    //生成农历月
    if(options&ChineseCalendarOptionMonth){
        if (wCurMonth < 1) {
    ...
    //生成农历日
    if(options&ChineseCalendarOptionDay){
...
-(NSString *)toChineseCalendarWithOptions:(ChineseCalendarOptions)options{
    return [NSDate chineseCalendarWithDate:self options:options];
}
